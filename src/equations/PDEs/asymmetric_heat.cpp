...
public:
    explicit AsymmetricHeat(const EqnConfig& eqn_config)
        : Equation(eqn_config),
          ...
          cos_weight_(eqn_config.params.value("cos_weight", 0.5)),
          tanh_weight_(eqn_config.params.value("tanh_weight", 0.1)),
          sin_frequency_(eqn_config.params.value("sin_frequency", 1.0)),
          cos_frequency_(eqn_config.params.value("cos_frequency", 1.0)),
          tanh_frequency_(eqn_config.params.value("tanh_frequency", 1.0)),
...
private:
    ...
    double cos_weight_;
    double tanh_weight_;
    double sin_frequency_;
    double cos_frequency_;
    double tanh_frequency_;
