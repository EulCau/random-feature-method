...
\ustcsetup{
  title                = {随机特征方法求解高维抛物型方程},
  title*               = {Solving High Dimentional Parabolic PDEs using Random Feature Method},
  author               = {刘行},
  author*              = {Liu Xing},
  speciality           = {信息与计算科学},
  speciality*          = {Information and Computing Science},
  supervisor           = {陈景润~教授},
  supervisor*          = {Prof. Jingrun Chen},
  ...
  student-id           = {PB22000150},  % 学号，本科生需要填写
  %
